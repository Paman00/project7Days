	...
	public static void main(String[] args) {
		...
		int cansancio = 0;
			...
			for (int i = 0; i < inventario.length; i++) {
				if (objetoInventario.equals(inventario[i])) {
					...
					System.out.println(agregarColor(
							centrarLinea("\nEfectivamente, un " + inventario[0] + " todo correcto"), Recursos.CYAN));
			...
			if (opcion == 3) {
				...
				cansancio++;
				System.out.println(
						centrarLinea(agregarColor("El cansacio de " + nombre + "aumenta en 1", Recursos.PURPLE)));
